...
<template>
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        v-if="showClose"
        class="absolute right-4 top-4 rounded-lg p-1 text-on-surface-variant/70 transition-opacity hover:opacity-100 hover:bg-surface-container-high focus:outline-none focus:ring-2 focus:ring-primary/40"
      >
        <X class="h-4 w-4" />
